...
- Click on the "Choose File" button and select the widget archive file donwloaded from [this project release section](https://github.com/contactlab/contacthub-connect-zendesk/releases/download/1.0/contacthub-app.zip)  
